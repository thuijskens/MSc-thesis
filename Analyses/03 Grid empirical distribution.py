...
if __name__ == "__main__":
  ...
  args = sys.argv[1:]
  if args[0] is None:
    filepath = "E:/MSc thesis/Processed data/train_smaller_binarized_trips.csv"
  else:
    filepath = args[0]
  ...
  # Flip the histogram  
  plt.imshow(np.log(hist.T[::-1]), extent = [lon_vals[0], lon_vals[1], lat_vals[0], lat_vals[1]])
