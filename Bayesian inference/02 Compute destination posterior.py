...
if __name__ == "__main__":
  ...
  filepath_val = "E:/MSc thesis/Processed data/Backup N = 75 M = 100/train_binarized_trips_validation.csv"
  filepath_probs = "E:/MSc thesis/Processed data/Backup N = 75 M = 100/prob_tables.csv"
  filepath_target = "E:/MSc thesis/Processed data/Backup N = 75 M = 100/prob_tables_shrinkage.csv"
  ...
  plt.subplot(1,3,2)
  plt.title("Partial trip")
  plt.imshow(trip_to_array(partial_trip.GRID_POLYLINE), interpolation = "nearest")
