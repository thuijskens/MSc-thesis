...
"""
01c Format training data for exploratory analysis.py

This script formats the training data so that it can be used for easy import in
R. The following variables are exported:
    - Hour of the day
    - Day of the week
    - Week of the year
...
if __name__ == "__main__":
  print "- 01d Format training data for exploratory analysis.py"
  ...
  expl_vars = ["TRIP_ID", "START_POINT_LON", "START_POINT_LAT", "END_POINT_LON", "END_POINT_LAT", "START_CELL", "END_CELL", "MINUTE", "HOUR", "WDAY", "DAY", "WEEK", "CALL_TYPE", "ORIGIN_CALL", "ORIGIN_STAND", "DISTANCE", "DURATION"]
  ...
  data_chunks = pd.read_csv(filepath_or_buffer = filepath,
                            ...
                            usecols = ["TRIP_ID","TIMESTAMP", "START_POINT", "END_POINT", "GRID_POLYLINE", "HOUR", "WDAY", "DURATION", "CALL_TYPE", "ORIGIN_CALL", "ORIGIN_STAND"],
  ...
  for idx, chunk in enumerate(data_chunks): 
    ...
    chunk["MDAY"] = chunk["TIMESTAMP"].dt.day
